...
namespace Transparency.Controls;
...
public partial class RadialGauge : RangeBase
{
    ...
    void RadialGauge_Unloaded(object sender, RoutedEventArgs e)
    {
    ...
    void ThemeListener_ThemeChanged(ThemeListener sender)
    {
        OnColorsChanged();
    }

    void RadialGauge_IsEnabledChanged(object sender, DependencyPropertyChangedEventArgs e)
    {
        OnEnabledChanged();
    }
