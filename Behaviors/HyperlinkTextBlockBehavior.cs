...
public class HyperlinkTextBlockBehavior : Behavior<TextBlock>
{
    ...
    protected override void OnAttached()
    {
        ...
        if (_textChangedRegistration == null)
            _textChangedRegistration = AssociatedObject.RegisterPropertyChangedCallback(TextBlock.TextProperty, OnTextPropertyChanged);
    }
    ...
    void OnTextPropertyChanged(DependencyObject sender, DependencyProperty dp)
    {
